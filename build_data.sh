...
wait
echo "$(tput setaf 1)$(tput setab 7)------- Interactions imported (3/9) --------$(tput sgr 0)" 1>&3
cd ..
...
wait
echo "$(tput setaf 1)$(tput setab 7)------- Interaction entries tagged Weinstein2016 data created (4/9) --------$(tput sgr 0)" 1>&3
