...
update doc with {pi: 0} in nodes_otl`);
...
update doc with {pi: 1} in nodes_otl`);
...
update doc WITH { pi: 0.45 } in nodes_otl`);
...
update doc WITH { pi: 0.55 } in nodes_otl`);
...
update doc with {pi: 0.5} in nodes_otl`);
